...
function convertInputToStringArrayGenetics2() {
    let expectedNextLines = 0;
    const outputStringArray = [];
    let numLinesRead = 0;
    return new Promise(resolve => rlGenetics2.on('line', (line) => {
...
let isOnlyAOrC = true;
let dnaIndex01 = 1;
function printVillainIndex(option1, option2, comparisonIndex) {
...
function genetics2(inputStringArray) {
    inputStringArray.map((line) => {
        if (N === 0) {
            const firstLine = line.split(" ");
...
runAllGenetics2();
//# sourceMappingURL=genetics2.js.map